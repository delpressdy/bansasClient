            ...
            <div class="animated fadeIn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Section name</label>
                                                        <input id="" name="departmentName" type="tel" class="form-control cc-cvc" value="<?php echo $rowi['departmentName'];?>" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="e.g Charity, Lilac, Rose">
                                                        </div>
                                                    </div>
                                                    <div>
                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">List of all Sections</h2></strong>
                            </div>
                            <div class="card-body">
