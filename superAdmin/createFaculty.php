...
if(isset($_POST['submit'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    if($ret > 0){
      ...
      $statusMsg="This room is already exist!";
  ...
  $query=mysqli_query($con,"insert into tblfaculty(facultyName,dateCreated) value('$facultyName','$dateCreated')");
    ...
    {
      $alertStyle ="alert alert-danger";
      $statusMsg="Murag naa problema sa database!";
    }
  }
}
  ?>
            ...
            <div class="animated fadeIn">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Room name<i class="text-danger">*</i></label>
                                                        <input id="" name="facultyName" type="tel" class="form-control cc-exp" value="" placeholder="Room Name" required autofocus>
                                                    </div>
                                                </div>
                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">List</h2></strong>
                            </div>
                            <div class="card-body">
