...
if (isset($_GET['matricNo']) && isset($_GET['departmentId'])  && isset($_GET['semesterId'])) {
    ...
    $levelQuery = mysqli_query($con, "SELECT * FROM tbldepartment INNER JOIN tbllevel ON tbllevel.levelId = tbldepartment.levelId where tbldepartment.departmentId = 26 ");
