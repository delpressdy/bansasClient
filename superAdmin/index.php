            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                               <h3 align="center"><b><marquee direction="left">Hello, <strong class="text-danger"><?php echo $staffFullName;?></strong></marquee></b></h3>
                            </div>
                        ...
                        <div class="card text-white bg-flat-color-3">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $countSection;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Sections</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-5">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $countPupils;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Pupils</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-1">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Subjects</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
             ...
             <div class="col-sm-6 col-lg-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h4 align="center">School Year: <?php 
