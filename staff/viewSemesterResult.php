                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center" class="text-black" style="font-family: cursive;"><?php echo  $rowStd['firstName'].' '.$rowStd['lastName']?></h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="text-danger">[<?php echo $rowLevel['levelName'];?>]</b>&nbsp;<b class="text-success">[<?php echo $rowSemester['semesterName'];?>]</b></strong>
                            </div>
                            <div class="card-body">
...
<!-------------------------- FROM THE FINAL RESULT TABLE --------------------------->
            <table id="printTable1" class="table table-striped table-bordered">
                <thead>
                <tr>
        ...
        $cnt=$cnt+1;
                ...
                <a href="studentList3.php" class="btn btn-danger">Go Back</a>
                <button class="btn btn-info" onClick="window.print()">Print results</button>
            </div>
        </div>
    </div>
...
<script src="../assets/js/lib/data-table/datatables.min.js"></script>
    ...
    // PARA SA PRINT BUTTON NI, E REMOVE LANG ANG COMMENT PARA TABLE LANG ANG E PRINT DLI ANG WINDOW JD.
