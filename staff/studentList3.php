...
function showValues(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","generateGradeAjax.php?fid="+str,true);
        xmlhttp.send();
    }
}
</script>
            ...
            <div class="animated fadeIn">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h3 align="center">Select details</h3></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                ...
                <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h3 align="center">List of pupils</h3></strong>
                            </div>
                            <div class="card-body">
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    <td>
                        <a href="viewSemesterResult.php?semesterId=1&matricNo=<?php echo $row['matricNo'];?>&levelId=<?php echo $row['levelId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a>
                    </td>

                    <td>
                        <a href="viewSemesterResult.php?semesterId=2&matricNo=<?php echo $row['matricNo'];?>&levelId=<?php echo $row['levelId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a>
                    </td>

                    <td>
                        <a href="viewSemesterResult.php?semesterId=3&matricNo=<?php echo $row['matricNo'];?>&levelId=<?php echo $row['levelId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a>
                    </td>

                    <td>
                        <a href="viewSemesterResult.php?semesterId=4&matricNo=<?php echo $row['matricNo'];?>&levelId=<?php echo $row['levelId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a>
                    </td>

                    <td>
                        <a href="viewFinalResult.php?matricNo=<?php echo $row['matricNo'];?>" title="View Details"><i class="fa fa-eye fa-1x"></i> View</a>
                    </td>
